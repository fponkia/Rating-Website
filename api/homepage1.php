...
<html lang = "en">
    ...
    <body>
        <div id = "homehead">
            ...
            <aside id = "homeheadaside">
                <form id = "searchbar" action = "" method = "post">
                    <input type = "search" placeholder="type here to search.."></input>
                    <button type = "submit" value = "GO!">GO!</button>
                </form>

                <p id = "homepage1username"><?=$_SESSION["username"]?></p>

                <a href = "post.php" id = "posthomepage">Post</a>
    ...
    if($row["Average_Rating"]==""){
        ...
        ?>
            <div>
                ...
                <aside>
                    <h3><a href = "jokedetailpage.php?joke_id=<?=$row['joke_id']?>"><?=$row["title"]?></a></h3>
                    <p><?=$row["text"]?></p>
